...
impl Message {
    ...
    pub fn tool_response_named(tool_call_id: &str, tool_name: &str, content: &str) -> Self {
        Self {
            role: Role::Tool,
            content: content.to_string(),
    ...
    pub fn named(role: Role, name: &str, content: &str) -> Self {
        Self {
            role,
            content: content.to_string(),
    ...
    pub fn assistant_with_tool_calls(content: &str, tool_calls: Vec<crate::types::ToolCall>) -> Self {
        Self {
            role: Role::Assistant,
            content: content.to_string(),
            name: None,
