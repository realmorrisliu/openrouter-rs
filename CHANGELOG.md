...
- Canonicalized OpenAPI path-parameter names during drift comparison and classified standard error envelopes as already handled by the shared error parser.
